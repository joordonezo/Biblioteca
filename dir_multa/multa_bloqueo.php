...
$nuevafecha1 = strtotime('+20 day', strtotime($fecha1));
$nuevafecha1 = date('Y-m-j', $nuevafecha1);

$db_conexion->insertar("multa", "valor, fecha_inicio, fecha_corte, estado, persona_id, prestamo_id", "" . $total . ", '" . $fecha1 . "', '" . $nuevafecha1 . "', " . 1 . ", " . $per_p . ", " . $id);

$db_conexion->insertar("bloqueo_persona", "fecha_inicio, fecha_fin, estado, persona_id, persona_id1", "'" . $fecha1 . "', '" . null . "', " . 1 . ", " . $per_p . ", " . $_SESSION['id']);
?>
<div class="alert alert-warning col-xs-4 col-xs-offset-4 ">Se ha <b>BLOQUEADO</b> el usuario de <b><?php echo $nom_p ." ". $ape; ?></b> y queda restando <b>$ <?php echo $total; ?></b> de la multa</div>
<?php
$reno_num = 1;
...
$mensaje = "Hola!!! " . $nom_p . " " . $ape . " Se ha registrado recientemente la renovacion de tu prestamo al libro " . $nom_l . " - " . $aut . ", Recuerda que el libro lo has renovado hoy " . $fecha1
        ...
        . "\n\nSe ha BLOQUEADO tu usuario  ". $nom_p ." ". $ape." con una multa total de $ ". $total." no olvides pagarlos, ya que no podras prestar libros hasta que estes a paz y salvo.\nGracias por tu atencion.\n\n"
