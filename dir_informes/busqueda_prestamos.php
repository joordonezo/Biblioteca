...
if (isset($_POST['tipo']) && $_POST['tipo'] != "") {
    ...
    <div class="row">
        <div class="col-xs-4 col-xs-offset-4">
            <form action="inf_generado_pres.php" method="post" name="">
        ...
        <a class="btn btn-warning col-xs-2 col-xs-offset-5" href="sel_prestamos.php">Volver</a>
        <form action="inf_generado_pres_avan.php" method="post">
            <!-- Modal -->
        ...
        header("Location: sel_prestamos.php");
    }
