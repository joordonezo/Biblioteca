...
if (isset($_POST['tipo']) && $_POST['tipo'] != "") {
    ...
    <table class="table"> 
        <tr>
            ...
            <td class="alert-warning"><b>FECHA INICIO</b></td>
            <td class="alert-warning"><b>FECHA FIN</b></td>
            <td class="alert-warning"><b>ESTADO</b></td>
            <td class="alert-warning"><b>PERSONA</b></td>
            <td class="alert-warning"><b>LIBRO</b></td>
            <td class="alert-warning"><b>ADMINISTRADOR</b></td>
        </tr>
        <?php
        if($tipo == 5){
